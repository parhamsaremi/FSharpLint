...
with
    member this.Flatten() =
        [|
            ...
            this.indexGet |> Option.bind (constructRuleIfEnabled IndexGet.rule) |> Option.toArray
...
let flattenConfig (config:Configuration) =
    ...
    let allRules =
        [|
            ...
            config.IndexGet |> Option.bind (constructRuleIfEnabled IndexGet.rule)
